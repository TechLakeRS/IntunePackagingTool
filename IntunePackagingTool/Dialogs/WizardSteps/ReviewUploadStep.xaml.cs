...
namespace IntunePackagingTool.WizardSteps
{
            ...
            var ownerIds = new List<string>
    {
        ...
        private void EditAppDetailsButton_Click(object sender, RoutedEventArgs e)
        {
            // Trigger back navigation - wizard will handle going to correct step
            BackRequested?.Invoke(this, EventArgs.Empty);
        }

        private void EditDetectionRulesButton_Click(object sender, RoutedEventArgs e)
        {
            // Trigger back navigation - wizard will handle going to correct step
            BackRequested?.Invoke(this, EventArgs.Empty);
        }
